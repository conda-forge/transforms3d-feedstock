...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/transforms3d-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/transforms3d-feedstock)
...
Once the `conda-forge` channel has been enabled, `transforms3d` can be installed with:

```
conda install transforms3d
```

It is possible to list all of the versions of `transforms3d` available on your platform with:
